...
?>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="books.php" class="text-decoration-none text-muted fw-light">BookPublishers</a></li>
      ...
      <div class="row">
        <div class="col-md-3 text-center book-item">
          ...
          <img class="img-top" src="./image/<?php echo $row['book_image']; ?>">
          </div>
        </div>
        <div class="col-md-9">
                ...
                <hr>
                  ...
                  <form method="post" action="cart.php">
                    ...
                    <div class="text-center">
                      <input type="submit" value="Purchase / Add to cart" name="cart" class="btn btn-info rounded-0">
                    </div>
                  </form>
              </div>
            </div>
