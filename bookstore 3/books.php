...
?>
  <p class="text-center text-muted " style="font-size: 2em;">List of All Books</p>
        ...
        <?php while($book = mysqli_fetch_assoc($result)){ ?>
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 py-2 mb-2">
            ...
            <div class="img-holder overflow-hidden">
              <img class="img-top" src="./image/<?php echo $book['book_image']; ?>">
            </div>
            <div class="card-body bg-dark bg-gradient" style="min-height: 5em;">
