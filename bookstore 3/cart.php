...
?>
	<div class="card rounded-0 shadow">
		...
		<div class="card-footer text-end bg-dark text-white">
			<input type="submit" class="btn btn-secondary rounded-0" name="save_change" value="Save Changes" form="cart-form" style="margin-right:3em;">
			<a href="checkout.php" class="btn btn-info rounded-0"style="margin-right:3em;">Go To Checkout</a>
			<a href="books.php" class="btn btn-success rounded-0">Continue Shopping</a>
...
<?php
		...
		?>
<div class="alert alert-info rounded-0">Your cart is empty! Please add atleast 1 book to purchase first.</div>
<?php
