					...
					<div class="container-fluid text-white">
						...
						<form method="post" action="admin_edit.php?bookisbn=<?php echo $row['book_isbn'];?>" enctype="multipart/form-data">
								...
								<div class="text-center">
									<button type="reset" class="btn btn-warning btn-sm rounded-0 " style="margin-right:3em;">Cancel</button>
										<button type="submit" name="edit"  class="btn btn-info btn-sm rounded-0" style="margin-right:3em;">Update</button>
									<a href="admin_book.php" class="btn bg-danger text-white text-wrap btn-sm rounded-0 ">Go Back</a>
								</div>
						</form>
					</div>
				</div>
