...
<html lang="en">
  ...
  <body style="background: #E6E6FA;">
    ...
    <nav class="navbar navbar-expand-lg navbar-expand-md navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#topNav" aria-controls="topNav" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <a class="navbar-brand" href="index.php"> <i class="fa fa-book" aria-hidden="true"></i> MDJW Book Store</a>
        </div>
            ...
            <?php else: ?>
              ...
              <li class="nav-item"><a class="nav-link" href="cart.php"><span class="fa fa-shopping-cart"></span> My Cart</a></li>
                <?php if(isset($_SESSION['username']) && $_SESSION['username'] == true){ ?>
                    <li class="nav-item"><a class="nav-link" href="logout.php"><span class="fa fa-user-circle"></span> Logout</a></li>
                <?php }else {?>
                  <li class="nav-item"><a class="nav-link" href="login.php"><span class="fa fa-user-circle"></span> Login</a></li>
              <?php  } ?>
            <?php endif; ?>
            </ul>
        </div>
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      <div class="container">
        <br>
        <h1>Welcome to MDJW Kids’ Online Book Store</h1>
        <hr>
      </div>
    <?php } ?>
